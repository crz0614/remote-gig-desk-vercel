...
chrome.storage.local.get(["agentToken","hnUsername","lastSync"],v=>{token.value=v.agentToken||"";hn.value=v.hnUsername||"vesperChen";if(v.lastSync)status.textContent="最近同步："+new Date(v.lastSync).toLocaleString();});
