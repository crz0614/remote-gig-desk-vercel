# Engineering Portfolio · AI, Automation and Systems

Three production-oriented projects demonstrating end-to-end delivery across AI applications, full-stack product engineering and concurrent backend systems.
...
这组作品集覆盖 AI 应用、全栈产品和高并发后端系统，重点展示可以直接对应真实外包需求的完整交付能力。两个 Web 项目已经部署上线；Go 执行器通过 GitHub Actions 的格式检查、静态检查、竞态检测、测试和编译。
