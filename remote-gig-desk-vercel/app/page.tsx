...
export default function Home(){
  ...
  const [connections,setConnections]=useState<ChannelConnection[]>([]); const [authenticatedSites,setAuthenticatedSites]=useState<AuthenticatedSite[]>([]); const [queueing,setQueueing]=useState(false); const [queueNotice,setQueueNotice]=useState<{id:string;status:string;channel:string}|null>(null);
