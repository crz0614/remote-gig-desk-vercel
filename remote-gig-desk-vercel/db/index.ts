...
export function ensureDatabase() {
  ...
  initialized = (async () => {
    ...
    await sql`CREATE INDEX IF NOT EXISTS applications_owner_idx ON applications(owner_email, updated_at DESC)`;
    await sql`CREATE TABLE IF NOT EXISTS channel_connections (
