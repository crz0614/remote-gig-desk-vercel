export type ReplyClassification = {
  kind: "suspicious" | "offer" | "interview" | "assessment" | "rejection" | "receipt" | "action" | "info";
...
export function matchApplicationByTitle(subject: string, text: string, applications: { id: string; title: string }[]) {
